"""
Django settings for phd_admission project.
...
SECRET_KEY = 'django-insecure-5ybgvtxl@zocuwqloy37qc9$&qg_-iw%a+&1pzz_vw6^a9$m&h'
...
ROOT_URLCONF = 'phd_admission.urls'
...
WSGI_APPLICATION = 'phd_admission.wsgi.application'
